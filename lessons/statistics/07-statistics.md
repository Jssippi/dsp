...
>> Whereas Frequentist would take only work with the data within a given model, Bayesian statistics also incorporates prior information to inform the probabilities that are indicated in the data at hand. 
